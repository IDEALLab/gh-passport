...
import (
	...
	"github.com/IDEALLab/gh-passport/internal/passportrepo"
)
...
func TestSyncRequiresTrustedAppAndExactSHA(t *testing.T) {
	...
	pulls, _ := json.Marshal([]map[string]any{{
		"number": 7, "html_url": "https://github.com/IDEALLab/passport-exercises/pull/7", "state": "open", "merged": false,
	...
	repository := passportrepo.Repository{
		Root: ".", Owner: "student", Name: "passport-exercises", UpstreamOwner: "IDEALLab", UpstreamName: "passport-exercises", Branch: "onboarding/student",
	...
	if official.RecoveryIssueURL != "https://github.com/IDEALLab/passport-exercises/issues/new?template=passport-help.yml" {
