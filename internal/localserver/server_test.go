...
import (
	...
	"github.com/IDEALLab/gh-passport/internal/githubstatus"
...
func testServer(t *testing.T) *Server {
	...
	repository := passportrepo.Repository{
		Root: t.TempDir(), Owner: "student", Name: "passport-exercises", UpstreamOwner: "IDEALLab", UpstreamName: "passport-exercises", Branch: "onboarding/student",
		HeadSHA: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
		Passport: passportrepo.Passport{
			SchemaVersion: 2, CurriculumVersion: "1.2.0", GitHubUser: "student",
			SourceRepository: "IDEALLab/passport-exercises", ForkRepository: "student/passport-exercises", AssessmentBranch: "onboarding/student",
